    ...
    return (
        <Page>
            ...
            <Text className="text-lg mb-4">
                This page should ask you for captcha once, future refreshes or navigations to this page won&apos;t ask
                you again, unless the <Code>datadome</Code> cookie is removed
            </Text>
            <Text className="mb-4">
                To remove the cookie, open devtools, navigate to Application - Storage - Cookies, and remove the{' '}
                <Code>datadome</Code> cookie
            </Text>
